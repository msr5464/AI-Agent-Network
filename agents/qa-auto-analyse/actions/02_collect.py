...
def main():
    ...
    if report_dir.exists():
        try:
            from src.parsers.data_builder import get_execution_logs_from_html, get_test_durations_from_html
    ...
    try:
        from src.parsers.data_builder import get_full_report_data_from_db
